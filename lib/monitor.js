...
async function takeScreenshot(url, viewport = { width: 1280, height: 720 }, waitAfterLoad = 2000) {
...
async function checkSingleSite(siteId) {
  ...
  const waitAfterLoad = site.waitAfterLoad || defaults.waitAfterLoad || 2000;
